export const state = () => ({
  ...
  messages: [
    {
      slug: "defaultWelcomeMessage", // slug is name without space and with first word lowercase then capitalize
      name: "Default welcome message", // Entered by the customer
      variables: { 1: "guestFirstName", 2: "staffName" },
      data: `Hi --1--, this is --2--, from the Princes Street Hostel, I hope you are well and thanks again for booking with us. Could you please let us know what time you will be arriving tomorrow?\n\nPlease bear in mind we are at the very top of our building and there are a quite a few steps to reach reception level.\n\nSee you soon!`
    },
    {
      slug: "withArrivalTime",
      name: "With arrival time",
      variables: { 1: "guestFirstName", 2: "staffName", 3: "dayOfWeek", 4: "checkinTime" },
      data: `Hi --1--, this is --2-- from the Princes Street Hostel, I hope you are well and thanks again for booking with us. We look forward to welcoming you on --3-- --4--.\n\nPlease bear in mind we are at the very top of our building and there are a quite a few steps to reach reception level.\n\nSee you soon!`
    },
    {
      slug: "earlyCheckin",
      name: "Early Checkin",
      variables: { 1: "guestFirstName", 2: "staffName", 3: "dayOfWeek", 4: "checkinTime" },
      data: `Hi --1--, this is --2-- from the Princes Street Hostel, I hope you are well and thanks again for booking with us. We look forward to welcoming you on --3-- between --4--. Our official check-in time is at 3pm, however you are very welcome to leave your luggage here at reception, then you are free to explore Edinburgh!\n\nPlease bear in mind we are at the very top of our building and there are a quite a few steps to reach reception level.\n\nSee you soon!`
    }
  ]
})
