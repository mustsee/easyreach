  ...
  <div class="px-4">
    <div class="rounded-lg shadow-lg lg:flex">
      <div class="flex-1 px-6 py-8 bg-white lg:p-12">
        <h3 class="text-2xl font-extrabold text-gray-900 sm:text-3xl">Carolyn Mills</h3>
        <p class="mt-6 text-base text-gray-500 truncate">+44 7850 873058 <br/> cmills.362484@guest.booking.com</p>
        <div class="mt-8">
          ...
          <ul class="mt-8 space-y-5">
            <li class="lg:col-span-1">
              ...
              <p class="text-sm text-gray-700">between 15:00 and 16:00</p>
            </li>
            <li class="lg:col-span-1">
              <p class="text-gray-900">Guest comments</p>
              <p class="text-sm text-gray-700">Approximate time of arrival: between 15:00 and 16:00</p>
            </li>
          </ul>
        </div>
      </div>
      <div class="lg:w-3/5 px-6 py-8 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
        <select-component />
        <textarea-component class="mt-6"/>
        <div class="mt-8">
          <div class="action-button rounded-md shadow">
            <a 
              href="" 
              class="flex items-center justify-center w-full px-5 py-3 text-base font-medium text-primary-color bg-white border border-transparent rounded-md hover:text-white hover:bg-primary-color transition-all"
              target="_blank">
                Open in
