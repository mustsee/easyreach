...
<div class="grid gap-6 my-8 sm:grid-cols-2 lg:grid-cols-4">
  ...
  <div
    class="min-w-0 overflow-hidden shadow-md bg-white border-t-4 border-green-500"
  >
    <div class="p-4 flex items-center">
      <div
  ...
  <div
    class="min-w-0 overflow-hidden shadow-md bg-white border-t-4 border-orange-500"
  >
    <div class="p-4 flex items-center">
      <div
